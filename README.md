...
Please refer to the full specification at the source URL above for complete details on project guidelines. They must be analyzed before any other action and there after followed and enforced.
```
...
```
@github Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project.
```

2. For Copilot Chat in GitHub.com, use the `/guidance` command:

```
/guidance Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project.
```
...
```
Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project.
```
...
```json
{
  "systemInstruction": "Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project."
}
```
...
const systemPrompt = `Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project.`;
...
assistant = client.beta.assistants.create(
  model="gpt-4-turbo",
  instructions="Please follow the guidelines at https://github.com/robinsmedberg/ai-coding-guidelines/blob/main/Full%20Process%20for%20Coding%20with%20AI%20Coding%20Assistants.md when helping with this project.",
